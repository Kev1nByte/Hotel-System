...
class HDobleControlador{

	public function VerHDobleControlador(){

		$tablaBD = "hdoble";

		$respuesta = HDobleModelo::VerHDobleModelo($tablaBD);
	...
	public function EditarHDobleControlador(){

		$tablaBD = "hdoble";

		$id = "1";

		$respuesta = HDobleModelo::EditarHDobleModelo($tablaBD, $id);
	...
	public function ActualizarHDobleControlador(){
		...
		if(isset($_POST["precioE"])){
			...
			if(isset($_FILES["imagenE"]["tmp_name"]) && !empty($_FILES["imagenE"]["tmp_name"])){
				...
				if($_FILES["imagenE"]["type"] == "image/jpeg"){
					...
					$rutaImg = "views/img/hdoble/HD".$nombre.".jpg";
				...
				if($_FILES["imagenE"]["type"] == "image/png"){
					...
					$rutaImg = "views/img/hdoble/HD".$nombre.".png";
			...
			$respuesta = HDobleModelo::ActualizarHDobleModelo($tablaBD, $datosC);
