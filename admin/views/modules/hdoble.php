			...
			<div class="col-md-6 col-xs-12">
				...
				<div class="box box-danger">
					...
					<div class="box-body">
						...
						$verHDoble = new HDobleControlador();
						$verHDoble -> VerHDobleControlador();
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<form role="form" method="post" enctype="multipart/form-data">
				...
				$editarhDoble = new HDobleControlador();
				$editarhDoble -> EditarHDobleControlador();
...
$actualizarHDoble = new HDobleControlador();
$actualizarHDoble -> ActualizarHDobleControlador();
