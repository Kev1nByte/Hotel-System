          ...
          <table class="table table-bordered table-hover table-striped TB">
            ...
            <tbody>
              ...
              <?php
                ...
                $verUsuarios = new UsuariosControlador();
                $verUsuarios -> VerUsuariosControlador();
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          $crearUsuario -> CrearUsuariosControlador();
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form method="post" role="form" enctype="multipart/form-data">
          ...
          <div class="modal-body">
           ...
           <div class="box-body">
            ...
            <div class="form-group">
              ...
              <img src="views/img/usuarios/defecto.png" class="img-thumbnail visor" width="100px;"> 
          ...
          $actualizarUsuarios = new UsuariosControlador();
          $actualizarUsuarios -> ActualizarUsuariosControlador();
